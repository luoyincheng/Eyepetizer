...
public class SVGImageView extends AppCompatImageView {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            String css = a.getString(R.styleable.SVGImageView_SVGImageViewCss);
            if (css != null)
                renderOptions.css(css);

            // Check whether svg attribute is a resourceId
            int resourceId = a.getResourceId(R.styleable.SVGImageView_SVGImageViewSvg, -1);
            if (resourceId != -1) {
            ...
            String url = a.getString(R.styleable.SVGImageView_SVGImageViewSvg);
            if (url != null) {
