...
public class PathView extends View implements SvgUtils.AnimationStepListener {
    ...
    public static class AnimatorBuilder {
         ...
         *
         * @param timeInterpolator - Interpolator.
         * @return AnimatorBuilder.
         */
        public AnimatorBuilder interpolator(final TimeInterpolator timeInterpolator) {
    ...
    public static class AnimatorSetBuilder {
         ...
         * @return AnimatorSetBuilder.
         */
        public AnimatorSetBuilder interpolator(final TimeInterpolator timeInterpolator) {
            this.timeInterpolator = timeInterpolator;
            return this;
        }
