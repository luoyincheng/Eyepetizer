package com.yincheng.eyepetizer.widgets.helper;
...
public class ViewDragHelper {
    ...
    private Pair<View, View> leftAndRightView = null;
    ...
    public void captureChildView(@NonNull View childView, int activePointerId) {
        ...
        leftAndRightView = mCallback.onViewCaptured(childView, activePointerId);
        ...
        if (mDragState == STATE_SETTLING) {
            ...
            if (dx != 0) {
                ...
                if (leftAndRightView != null) {
                    View leftView = leftAndRightView.first;
                    if (leftView != null)
                        ViewCompat.offsetLeftAndRight(leftView, dx);
                    View rightView = leftAndRightView.second;
                    if (rightView != null)
                        ViewCompat.offsetLeftAndRight(rightView, dx);
                }
            }
            if (dy != 0) {
    ...
    private void dragTo(int left, int top, int dx, int dy) {
        ...
        if (dx != 0) {
            ...
            if (leftAndRightView != null) {
                View leftView = leftAndRightView.first;
                if (leftView != null)
                    ViewCompat.offsetLeftAndRight(leftView, clampedX - oldLeft);
                View rightView = leftAndRightView.second;
                if (rightView != null)
                    ViewCompat.offsetLeftAndRight(rightView, clampedX - oldLeft);
            }
        }
        if (dy != 0) {
