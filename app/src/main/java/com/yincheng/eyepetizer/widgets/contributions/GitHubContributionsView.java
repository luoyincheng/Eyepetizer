package com.yincheng.eyepetizer.widgets.contributions;
...
import com.yincheng.eyepetizer.widgets.contributions.utils.ColorsUtils;
import com.yincheng.eyepetizer.widgets.contributions.utils.DatesUtils;
...
public class GitHubContributionsView extends View {
    ...
    private float rectWidthMarginRatio = 0.1f;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        rectWidth = width * 1.0f / (53 + 52 * rectWidthMarginRatio);
        int height = (int) (7.6f * rectWidth);
    ...
    public Bitmap drawOnCanvas(List<ContributionsDay> contributionsFilter, List<ContributionsDay> contributions) {
        ...
        if (bitmap == null) {
            ...
            float marginBlock = (1.0F - 0.16667F);
            ...
            for (ContributionsDay day : contributionsFilter) {
                Log.i("fasdfadfadf", "contributionsFilter:" + contributionsFilter.size());
