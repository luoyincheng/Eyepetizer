...
import com.yincheng.closer.helpers.FileHelper
import com.yincheng.closer.provider.HTTP_CACHE_DIR
import com.yincheng.closer.provider.HTTP_MAX_CACHE
import com.yincheng.closer.provider.HTTP_TIME_OUT
...
enum class RetrofitInstance {
    ...
    private fun provideOkHttpClient(): OkHttpClient? {
        if (mOkHttpClient == null) {
            val cache = Cache(
                FileHelper.getCacheDir(CloserApplication.getApplication(), HTTP_CACHE_DIR),
                HTTP_MAX_CACHE
            )
