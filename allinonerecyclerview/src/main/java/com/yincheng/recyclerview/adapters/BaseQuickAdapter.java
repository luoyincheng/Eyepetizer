 ...
 */
package com.yincheng.recyclerview.adapters;
...
import com.yincheng.recyclerview.animation.AlphaInAnimation;
import com.yincheng.recyclerview.animation.BaseAnimation;
import com.yincheng.recyclerview.animation.ScaleInAnimation;
import com.yincheng.recyclerview.animation.SlideInBottomAnimation;
import com.yincheng.recyclerview.animation.SlideInLeftAnimation;
import com.yincheng.recyclerview.animation.SlideInRightAnimation;
import com.yincheng.recyclerview.entity.IExpandable;
import com.yincheng.recyclerview.loadmore.LoadMoreView;
import com.yincheng.recyclerview.loadmore.SimpleLoadMoreView;
import com.yincheng.recyclerview.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public void loadMoreEnd(boolean gone) {
        ...
        if (gone) {
            ...
            mLoadMoreView.setLoadMoreStatus(LoadMoreView.Companion.getSTATUS_END());
    ...
    public void loadMoreComplete() {
        ...
        mLoading = false;
        mNextLoadEnable = true;
        mLoadMoreView.setLoadMoreStatus(LoadMoreView.Companion.getSTATUS_DEFAULT());
        notifyItemChanged(getLoadMoreViewPosition());
    }
    ...
    public void loadMoreFail() {
        ...
        mLoading = false;
        mLoadMoreView.setLoadMoreStatus(LoadMoreView.Companion.getSTATUS_FAIL());
        notifyItemChanged(getLoadMoreViewPosition());
    }
    ...
    private K getLoadingView(ViewGroup parent) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mLoadMoreView.getLoadMoreStatus() == LoadMoreView.Companion.getSTATUS_FAIL()) {
                    notifyLoadMoreToLoading();
                }
                if (mEnableLoadMoreEndClick && mLoadMoreView.getLoadMoreStatus() == LoadMoreView.Companion.getSTATUS_END()) {
                    notifyLoadMoreToLoading();
                }
            }
        });
    ...
    public void notifyLoadMoreToLoading() {
        if (mLoadMoreView.getLoadMoreStatus() == LoadMoreView.Companion.getSTATUS_LOADING()) {
            return;
        }
        mLoadMoreView.setLoadMoreStatus(LoadMoreView.Companion.getSTATUS_DEFAULT());
        notifyItemChanged(getLoadMoreViewPosition());
    ...
    private void autoLoadMore(int position) {
        ...
        if (mLoadMoreView.getLoadMoreStatus() != LoadMoreView.Companion.getSTATUS_DEFAULT()) {
            return;
        }
        mLoadMoreView.setLoadMoreStatus(LoadMoreView.Companion.getSTATUS_LOADING());
        if (!mLoading) {
            mLoading = true;
            if (getRecyclerView() != null) {
